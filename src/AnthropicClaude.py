...
header_b = {"User-Agent": f"{user_agent}", "Referer": "https://claude.ai/chat",
    "Origin": "https://claude.ai", "Content-Type": "application/json", "Accept-Language": "en-US,en;q=0.5"}
# ------------------------------------------------------------------------------
...
class Anthropic():
     ...
     def load_cookie():
      ...
      def create_new_chat():
          ...
          requests.request(
                "POST", f"{link}organizations/{uuid_organization}/chat_conversations", headers=headers, data=payload)
      # ------------------------------------------------------------------------------
      ...
      def list_conversation():
          ...
          try:
              response = requests.get(
                    f"{link}organizations/{uuid_organization}/chat_conversations", headers=headers)
              data = response.json()
      ...
      def send_message(prompt):
          ...
          try:
              response = requests.post(
                    f"{link}append_message", headers=headers, data=payload, stream=True)
      ...
      def delete_conversation():
          ...
          headers.update(header_b)
          requests.request(
                "DELETE", f"{link}organizations/{uuid_organization}/chat_conversations/{uuid_conversation}", headers=headers, data=payload)
#-----------------------------------------------------------------------------
